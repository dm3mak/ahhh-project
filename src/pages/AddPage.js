                    ...
                    <Row>
                        ...
                        <Col xs={12}>
                            <Form.Group >
                                ...
                                <Form.Control as="select" onChange={(event)=> {this.setState({promoType: event.target.value})}}>
                                    <option disabled selected={true}>Select your option</option>
                                    <option>Eat</option>
                                    <option>Drink</option>
                                    <option>Sleep</option>
                                    <option>Shop</option>
                        ...
                        <Col xs={6} lg={2}>
                            ...
                            <Form.Group >
                                ...
                                <Form.Control as="select" selected={true} onChange={(event)=> {this.setState({promoStart: event.target.value})}}>
